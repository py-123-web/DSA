...
public class CourseUI {
    ...
    public void programme_courseUI() {
        ...
        System.out.println("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
        System.out.printf("%-15s %-29s %-15s %-30s %-12s %-20s %-12s %-10s %-12s %-10s%n", "Programme Code", "Programme Name", "Course Code", "Course Name", "Class Type", "Semester", "Credit Hour", "Fees", "Faculty", "Status");
        System.out.println("------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
    }

    public void printProgrammeCourse(String programmeCode, String programmeName, String courseCode, String courseName, String classType, String semester, Integer creditHour, Double fees, String faculty, String status) {
    // Maximum characters per line for programmeName
    int maxCharsPerLine = 29;
    ...
    System.out.printf("%-15s %-29s %-15s %-30s %-12s %-20s %-12d %-10.2f %-12s %-10s%n", programmeCode, programmeName, courseCode, courseName, classType, semester, creditHour, fees, faculty, status);
}
...
////            System.out.printf("%-15s %-29s %-15s %-30s %-12s %-20s %-12d %-10.2f %-12s %-10s%n", programmeCode, firstLineProgrammeName, courseCode, firstLineCourseName, classType, semester, creditHour, fees, faculty,status);
////
...
////            System.out.printf("%-15s %-29s %-15s %-30s%n", "", remainingProgrammeName, "", remainingCourseName);
////
////        } else {
//            // Print the formatted output
//            System.out.printf("%-15s %-29s %-15s %-30s %-12s %-20s %-12d %-10.2f %-12s %-10s", programmeCode, programmeName, courseCode, courseName, classType, semester, creditHour, fees, faculty,status);
////        }
//    }
...
//    }
    ...
    public void search_header() {
        System.out.println();
        System.out.println("Searching output");
        System.out.println("---------------------------------------------------------------------------------------------------------------------------------------");
        System.out.printf("%-15s %-35s %-12s %n", "Course Code", "Course Name",  "Semester");
        System.out.println("---------------------------------------------------------------------------------------------------------------------------------------");
    }
    
    public void search_ouput() {
        System.out.println();
        System.out.println("Searching output");
        System.out.println("---------------------------------------------------------------------------------------------------------------------------------------");
        System.out.printf("%-15s %-35s %-12s %n", "Course Code", "Course Name",  "Semester");
