...
//        initializer.ProgrammeInfo();
    ...
    public void printProgramme(String programmeCode, String courseCode, String courseName) {
        ...
        // Print the formatted output
        System.out.printf("%n | %-15s | %-15s | %-30s | %n%n", programmeCode, courseCode, courseName);
    }
...
//        Iterator<Course> courseIterator = initializer.courseList.iterator();
    ...
    public void courseReportUI() {
        ...
        System.out.printf("%-30s %-30s %n", "", "TUNKU ABDUL RAHMAN UNIVERSITY OF MANAGEMENT AND TECHNOLOGY UNIVERSITY SYSTEM COURSE REPORT", "");

        System.out.printf("%-50s %-50s %-30s%n", "", "------------------------------------------------------------", "");

        DateTime.currentDateTime();
        System.out.println();
        System.out.printf("%-5s %-25s %-25s %-15s %-10s %-10s%n", "", "COURSE CODE", "COURSE NAME", "SEMESTER", "CREDIT HOUR", "TUITION FEES");
        System.out.printf("%-5s %-25s %-25s %-15s %-10s %-10s%n", "", "-----------", "-----------", "-----------", "-----------", "-----------"); // Adjust the length of each separator as per the corresponding title width
    }

    public void courseReport(int no, String courseCode, String courseName, String semester, int creditHour, double fees) {
        System.out.printf("%-5d %-12s %-35s %-22s %-10d %-12.2f%n", no, courseCode, courseName, semester, creditHour, fees);
    }
    ...
    public void progReportUI() {
        ...
        System.out.printf("%-30s %-30s %n", "", "TUNKU ABDUL RAHMAN UNIVERSITY OF MANAGEMENT AND TECHNOLOGY UNIVERSITY SYSTEM PROGRAMME REPORT", "");
    ...
    public void endprogReportUI() {
        System.out.printf("\n%-30s %-30s %-20s%n", "", "END OF THE PROGRAMME REPORT", "");
           System.out.println("============================================================================================================================================================================================================");

    }

    public void endcourseReportUI() {
        System.out.printf("\n%-30s %-30s %-20s%n", "", "END OF THE COURSE REPORT", "");
       System.out.println("=================================================================================================================================================================");
